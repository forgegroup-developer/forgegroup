...
export default async function CasoStudioDetail({ params }: Props) {
  ...
  return (
    <>
      ...
      {/* PRIMA / DOPO — vedi CaseStudyDetail in produzione */}
      {c.beforeAfter.length > 0 && (
        <section className="py-16 md:py-24 section-bianco">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-xs uppercase tracking-widest text-brand-corallo font-bold mb-4">✦ Prima e dopo</p>
            <p className="text-brand-grigio text-sm">Usa il template CaseStudyBeforeAfter (bozza archiviata).</p>
          </div>
        </section>
      )}
