/**
 * Le domande sono quelle fatte davvero nelle videochiamate conoscitive
 * (Pasto System 21/07, Ristrutturazioni Generali 15/07, Solar Service
 * 22/07, Athene 27/08), con le parole di chi le ha fatte. Le risposte
 * dicono quello che in quelle call e' stato risposto: niente di piu'.
 *
