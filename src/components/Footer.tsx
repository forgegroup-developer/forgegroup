...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-panna border-t border-brand-bordo" style={{ backgroundColor: '#fbf5f2' }}>
      {/* CTA strip */}
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                ...
                className="w-9 h-9 rounded-full border border-brand-bordo bg-brand-bianco flex items-center justify-center text-brand-grigio hover:text-brand-corallo hover:border-brand-corallo transition-colors"
              >
