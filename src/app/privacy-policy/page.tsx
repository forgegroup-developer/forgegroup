  ...
  return (
    <>
      <HeroGooeySection innerClassName="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="heading-section font-semibold text-brand-nero leading-tight">Privacy Policy</h1>
      </HeroGooeySection>
      ...
      <article className="py-12 md:py-16 section-bianco">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg">
          ...
          <h2 className="text-xl font-semibold md:text-3xl font-bold text-brand-nero mt-10 mb-4">Dati raccolti</h2>
          ...
          <h2 className="text-xl font-semibold md:text-3xl font-bold text-brand-nero mt-10 mb-4">Base giuridica</h2>
          <p className="text-brand-grigio leading-relaxed mb-6">
          ...
          <h2 className="text-xl font-semibold md:text-3xl font-bold text-brand-nero mt-10 mb-4">Sicurezza dei dati</h2>
          <p className="text-brand-grigio leading-relaxed mb-6">
