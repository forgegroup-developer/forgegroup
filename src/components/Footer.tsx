          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                ...
                className="w-9 h-9 rounded-full border border-brand-corallo bg-brand-bianco flex items-center justify-center text-brand-corallo hover:bg-brand-corallo hover:text-white transition-colors"
              >
